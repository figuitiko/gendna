      ...
      <div class="row">
        <div class="col-lg-4 col-12 white-bg p-4 p-md-6">
          <a class="footer-logo" href="index.html">
            <img id="footer-logo" class="img-fluid" src="<?php echo get_theme_file_uri().'/assets/images/logo.png' ?>" alt="">
          </a>
          ...
          <div class="row align-items-center">
            <div class="col-5 d-flex align-items-center">
              ...
              <a href="product-left-image.html">
                <img class="img-fluid" src="<?php echo get_theme_file_uri().'/assets/images/product/01.jpeg' ?>" alt="...">
              </a>
            </div>
            <div class="col-7">
              <!-- Title -->
          ...
          <div class="row align-items-center">
            <div class="col-5 d-flex align-items-center">
              ...
              <a href="product-single.html">
                <img class="img-fluid" src="<?php echo get_theme_file_uri().'/assets/images/product/02.jpeg' ?>" alt="...">
              </a>
            </div>
            <div class="col-7">
              <!-- Title -->
